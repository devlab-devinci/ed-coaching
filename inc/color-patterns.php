 ...
 */
function edcoaching_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter EdCoachTheme default saturation level.
	 *
	 * @since EdCoachTheme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'edcoaching_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.edcoaching-front-page) .entry-title,
...
.colors-custom .edcoaching-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.edcoaching-front-page .panel-content .recent-posts article,
...
.colors-custom.edcoaching-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters EdCoachTheme custom colors CSS.
	 *
	 * @since EdCoachTheme 1.0
	 *
	 ...
	 */
	return apply_filters( 'edcoaching_custom_colors_css', $css, $hue, $saturation );
}
